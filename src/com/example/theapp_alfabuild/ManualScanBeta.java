...
public class ManualScanBeta extends ListActivity {
 ...
 // Progress Dialog
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ManualScanBeta.this);
	...
	public void addComment(View v) {
		Intent i = new Intent(ManualScanBeta.this, AddMessage.class);
		startActivity(i);
	}
	
	public void back(View v) {
		Intent i = new Intent(ManualScanBeta.this, Add_Scan.class);
		startActivity(i);
	}
	
	public boolean hasMessages(ArrayList<HashMap<String, String>> list){
		boolean has=false;
            	...
            	Log.d("Messages avaible, start scanning! IN MANUAL SCAN !", jsonMsg.toString());   
 	        	...
 	        	for(int i=0; i<messagesJson.length();i++){
 	            	...
 	            	//if(m.getInt(TAG_ID_USER) != idUserSP){//am inlocuit idUser cu idUserSP
 	            		...
 	            		map.put(TAG_ID_MSG, idMsgString);
	...
	public void updateList(){
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String idMsg=xPEMList.get(position).get(TAG_ID_MSG);
				
				Bundle dateMessage = new Bundle();
            	dateMessage.putString(TAG_ID_MSG, idMsg);
				
				Intent i =new Intent(ManualScanBeta.this, Comment.class);
				
				i.putExtras(dateMessage);
	...
	public class LoadMessages extends AsyncTask<Void, Void, Boolean>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(ManualScanBeta.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			pDialog.dismiss();
			if(hasMessages(xPEMList)==true){
				updateList();
			}else{
	    		Toast.makeText(ManualScanBeta.this, "No messages were embeded here!! ", Toast.LENGTH_LONG).show();
	    		Intent i = new Intent(ManualScanBeta.this, Add_Scan.class);
	    		startActivity(i);
			}
		}
